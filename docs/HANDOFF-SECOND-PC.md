...
**HEAD على `main`:** (يُحدَّث بعد الدفع) — سقف capture + واتساب /order + حد منتجات الباقة  
...
يجب أن ترى أحدث commit تقريباً: capture/واتساب/حد منتجات (أو أحدث إن وُجدت دفعات لاحقة).
